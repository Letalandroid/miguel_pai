...
const jobsMock: Job[] = [
  ...
  },
  {
    ...
    description:
      "Buscamos un analista de sistemas para identificar necesidades, diseñar soluciones y mejorar procesos empresariales.",
    requirements: [
                    ...
                    {resumeFile && (
                      <div className="flex items-center justify-between p-2 bg-content2 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-small truncate max-w-[250px]">
                            {resumeFile.name}
                          </span>
                        </div>
                        <Button
                    ...
                    <div className="bg-content2 p-4 rounded-lg">
                      <p className="text-small flex items-center gap-1">
                        <Icon
                          ...
                          className="text-primary"
                        />
                        Al postular, aceptas que la empresa tenga acceso a tu
