...
const notificationsMock: Notification[] = [
  {
    ...
    message: "Se ha publicado un nuevo taller: 'Habilidades Blandas para el Éxito Profesional'. ¡Inscríbete ahora!",
  ...
  },
  {
    ...
    message: "Tienes una reunión programada para mañana a las 10:00 AM: 'Orientación Profesional'.",
  ...
  },
  {
    ...
    message: "Se ha publicado una nueva convocatoria laboral que podría interesarte: 'Desarrollador Frontend' en Tech Solutions.",
  ...
  },
  {
    ...
    message: "Tu postulación para 'Diseñador UX/UI' en Creative Solutions ha sido aceptada. Pronto te contactarán para una entrevista.",
  ...
  },
  {
    ...
    message: "Por favor, actualiza tu perfil con tu información académica más reciente para mejorar tus oportunidades laborales.",
...
export const GraduateNotifications: React.FC = () => {
