...
import { CompanyDashboard } from "../feactures/company/pages/dashboard";
import { CompanyProfile } from "../feactures/company/pages/profile";
import { CompanyJobs } from "../feactures/company/pages/jobs";
import { CompanyMeetings } from "../feactures/company/pages/meetings";
import { CompanyAvailability } from "../feactures/company/pages/availability";
import { CompanyNotifications } from "../feactures/company/pages/notifications";
...
export const CompanyLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { name: "Mi Perfil", path: "profile", icon: "lucide:building" },
    { name: "Convocatorias", path: "jobs", icon: "lucide:briefcase" },
    { name: "Reuniones", path: "meetings", icon: "lucide:users" },
    { name: "Disponibilidad", path: "availability", icon: "lucide:calendar" },
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <Navbar isBordered maxWidth="xl" className="bg-content1">
        <NavbarBrand>
          ...
          />
          <p className="font-bold text-inherit ml-2">UCV Empresas</p>
        </NavbarBrand>
      ...
      <main className="flex-grow p-4 md:p-6">
        <Switch>
          ...
          <Route path={`${path}/jobs`} component={CompanyJobs} />
          <Route path={`${path}/meetings`} component={CompanyMeetings} />
          <Route
